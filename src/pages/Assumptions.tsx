...
export default function Assumptions({
  ...
  const groups = [
    { title: 'Company & Balance Sheet', fields: ['initial_equity_value', 'initial_cash', 'BTC_treasury', 'shares_basic', 'shares_fd', 'opex_monthly', 'annual_burn_rate', 'tax_rate', 'nols'] },
    { title: 'Market & BTC Process', fields: ['BTC_current_market_price', 'targetBTCPrice', 'mu', 'sigma', 't', 'risk_free_rate', 'expected_return_btc', 'delta'] },
    { title: 'Capital Structure & Routes', fields: ['structure', 'LoanPrincipal', 'new_equity_raised', 'cost_of_debt', 'IssuePrice', 'adv_30d', 'atm_pct_adv', 'pipe_discount', 'fees_ecm', 'fees_oid'] },
    { title: 'Risk Constraints / Covenants', fields: ['LTV_Cap', 'cure_period_days', 'haircut_h0', 'haircut_alpha', 'liquidation_penalty_bps'] },
    { title: 'Hedging', fields: ['hedge_policy', 'hedge_intensity', 'hedge_tenor_days', 'deribit_iv_source', 'manual_iv'] },
    { title: 'Optimizer Objectives & Limits', fields: ['objective_preset', 'cvar_on', 'max_dilution', 'min_runway_months', 'max_breach_prob', 'min_profit_margin', 'min_profit_margin_constraint', 'wacc_cap', 'kappa_btc', 'nsga_pop_size', 'nsga_n_gen', 'lambda_dilution', 'lambda_runway', 'lambda_breach', 'lambda_wacc', 'lambda_profit_margin'] },
    { title: 'Simulation & Jumps (Advanced)', fields: ['paths', 'bootstrap_samples', 'jump_intensity', 'jump_mean', 'jump_volatility', 'vol_mean_reversion_speed', 'long_run_volatility', 'use_variance_reduction', 'opex_stress_volatility', 'dilution_vol_estimate', 'capex_schedule'] },
  ];
